    ...
    descriptor.value = function () {
      ...
      invariant(
        ...
        'loadProgress[' +
          ...
          '-\u9876\u90E8\u8FDB\u5EA6\u6761UI]:\u60A8\u7684\u7EC4\u4EF6\u5B9E\u4F8B\u6CA1\u6709store\u53D8\u91CF,\u8BF7\u68C0\u67E5\u662F\u5426\u7ED1\u5B9Astore'
      );
      var __mobxDecorators =
        props[options.store]['__mobxDecorators'] ||
        props[options.store]['__mobxInitializedProps'];
      invariant(
        __mobxDecorators && __mobxDecorators[options.state],
        'loadProgress[' +
          target.constructor.name +
          '-\u9876\u90E8\u8FDB\u5EA6\u6761UI]:\u60A8\u7684\u7EC4\u4EF6\u5B9E\u4F8Bstore\u5BF9\u8C61\u4E0A\u9700\u8981\u76D1\u542C\u7684\u5C5E\u6027\u6CA1\u6709\u88AB@observable\u5305\u88F9,\u8BF7\u53C2\u7167observable[mobx]\u7528\u6CD5'
      );
        ...
        if (descriptor.ReactionList.length === 0) {
          var Reaction = reaction(
            ...
            function (state, reaction) {
              invariant(
                props[options.store][options.state] instanceof
                  ObservablePromiseModel,
                'loadProgress[\u9876\u90E8\u8FDB\u5EA6\u6761UI-' +
                  target.constructor.name +
                  ']:\u60A8\u5728store\u5BF9\u8C61\u91CC\u9762\u9700\u8981\u76D1\u542C\u7684state\u539F\u578B\u4E0D\u662FObservablePromiseModel'
              );
              if (state) {
                if (state === 'pending') {
    ...
    descriptor.value = function () {
      ...
      invariant$1(
        ...
        'submittingAutoMessage[' +
          target.constructor.name +
          '-\u81EA\u52A8\u5F39\u51FA\u63D0\u793A\u64CD\u4F5C\u4FE1\u606F]:\u60A8\u7684\u7EC4\u4EF6\u5B9E\u4F8B\u6CA1\u6709store\u53D8\u91CF,\u8BF7\u68C0\u67E5\u662F\u5426\u7ED1\u5B9Astore'
      );
      var __mobxDecorators =
        viewStore['__mobxDecorators'] || viewStore['__mobxInitializedProps'];
      invariant$1(
        __mobxDecorators && __mobxDecorators[options.state],
        'submittingAutoMessage[' +
          target.constructor.name +
          '-\u81EA\u52A8\u5F39\u51FA\u63D0\u793A\u64CD\u4F5C\u4FE1\u606F]:\u60A8\u7684\u7EC4\u4EF6\u5B9E\u4F8Bstore\u5BF9\u8C61\u4E0A\u9700\u8981\u76D1\u542C\u7684\u5C5E\u6027\u6CA1\u6709\u88AB@observable\u5305\u88F9,\u8BF7\u53C2\u7167observable[mobx]\u7528\u6CD5'
      );
      if (__mobxDecorators && __mobxDecorators[options.state]) {
        if (descriptor.ReactionList.length === 0) {
          var Reaction = reaction(
            ...
            function (store, reaction) {
              invariant$1(
                viewStore[options.state] instanceof ObservablePromiseModel,
                'submittingAutoMessage[\u81EA\u52A8\u5F39\u51FA\u63D0\u793A\u64CD\u4F5C\u4FE1\u606F-' +
                  target.constructor.name +
                  ']:\u60A8\u5728store\u5BF9\u8C61\u91CC\u9762\u9700\u8981\u76D1\u542C\u7684state\u539F\u578B\u4E0D\u662FObservablePromiseModel'
              );
              if (store) {
                    ...
                    store.value &&
                      ...
                      message.success(
                        React.createElement(
                          ...
                          store.value && store.value.message
                        )
                      );
                  } else {
...
export { loadProgress, submittingAutoMessage };
