...
(function (global, factory) {
    ...
    */
    ...
    var DexieUtils = /** @class */ (function () {
        function DexieUtils() {
        }
        DexieUtils.getInstanceDexie = function (key) {
            var store = this.dexies.find(function (ws) { return ws.key && ws.key === key; });
            if (store) {
                return {
                    key: key,
                    db: store.db,
        ...
        DexieUtils.registerInstanceDexie = function (store, key, schema) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                db = new Dexie(name);
                                return [4 /*yield*/, Dexie.exists(db.name)];
                            case 1:
                                if (!(_a.sent())) {
                                    db.version(1).stores({});
                                }
            ...
            if (dbItem && dbItem.db) {
                ...
                if (!this.getInstanceDexie(key)) {
                    ...
                    init(store).then(function (result) {
                        if (_this.getInstanceDexie(key) &&
                            _this.getInstanceDexie(key).openState === 'pending') {
                            _this.dexies = _this.dexies.map(function (item) {
                                if (item.key === key) {
                                    return __assign(__assign({}, item), { db: result, openState: 'complete' });
                                }
                                return item;
                            });
                        }
