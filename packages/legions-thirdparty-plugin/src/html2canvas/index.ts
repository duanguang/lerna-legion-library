...
export const Canvas2Image = (function () {
  ...
  return {
    ...
    saveAsPNG: function (canvas, width: number, height: number) {
      return saveAsImage(canvas, width, height, 'png');
    },
    saveAsJPEG: function (canvas, width: number, height: number) {
      return saveAsImage(canvas, width, height, 'jpeg');
    },
    saveAsGIF: function (canvas, width: number, height: number) {
      return saveAsImage(canvas, width, height, 'gif');
    },
    saveAsBMP: function (canvas, width: number, height: number) {
      return saveAsImage(canvas, width, height, 'bmp');
    },

    convertToImage: convertToImage,
    convertToPNG: function (canvas, width: number, height: number) {
      return convertToImage(canvas, width, height, 'png');
    },
    convertToJPEG: function (canvas, width: number, height: number) {
      return convertToImage(canvas, width, height, 'jpeg');
    },
    convertToGIF: function (canvas, width: number, height: number) {
      return convertToImage(canvas, width, height, 'gif');
    },
    convertToBMP: function (canvas, width: number, height: number) {
