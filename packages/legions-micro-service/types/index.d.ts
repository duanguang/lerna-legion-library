...
import { initGlobalState, getMicroAppStateActions } from './app/globalState';
...
export { MicroApps, start, loadMicroApp, MountedMicroApps, registerMicroApps, setDefaultMountApp, getMountedApps, initGlobalState, getMicroAppStateActions, runDefaultMountEffects, runAfterFirstMounted, };
