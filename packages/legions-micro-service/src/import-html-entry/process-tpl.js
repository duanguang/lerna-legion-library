...
export var genLinkReplaceSymbol = function (linkHref) { return '<!-- link '+linkHref+' replaced by import-html-entry -->' };
...
export var genScriptReplaceSymbol = function (scriptSrc) {return '<!-- script '+scriptSrc+' replaced by import-html-entry -->' };
export var inlineScriptReplaceSymbol = '<!-- inline scripts replaced by import-html-entry -->';
export var genIgnoreAssetReplaceSymbol = function (url) {return '<!-- ignore asset '+url || 'file'+' replaced by import-html-entry -->' };
