...
var legionsMicroservice = (function (exports) {
	...
	***************************************************************************** */
	...
	(function (global, factory) {
	   ...
	   * @since 2019-02-25
	   */
	  var isIE = typeof navigator !== 'undefined' && navigator.userAgent.indexOf('Trident') !== -1;
	  ...
	  function getGlobalProp(global) {
	      ...
	      for (var p in global) {
			  ...
			  console.log(hasIframe,cnt,p,secondGlobalProp,firstGlobalProp,lastGlobalProp,888)
	          if (!hasIframe &&
	          ...
	          if (res.getScripts) {
	            ...
	            Promise.all(promiseLoadScript_1).then(function (values) {
	              res.execScripts(window).then(function (value) {
					console.log(res,value['react15-home']['mount'](),33)
	                isCheckRegister.call(that);
	                currentEnvironment = 'sandbox';
	                apps.render && apps.render();
	              });
