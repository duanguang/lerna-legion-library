...
var legionsMicroservice = (function (exports) {
	...
	***************************************************************************** */
	      ...
	      return getExternalScripts(scripts).then(function (scriptsText) {
	          ...
	          function exec(scriptSrc, inlineScript, resolve) {
	              if (scriptSrc === entryMain) {
	                  ...
	                  var exports = proxy[getGlobalProp( window)] || {};
	                  resolve(exports);
	              }
	              else {
	 ...
	 */
	var t$1="[[ProxyTarget]]",n$1="[[Get]]",r$1="[[Set]]",e$1="[[Call]]",o$1=Object.defineProperty,i$1=Object.defineProperties,u$1=Object.getPrototypeOf,c$1=Object.getOwnPropertyDescriptor,a$1=!!i$1&&s$1(i$1),f$a=a$1?Object.__proto__?u$1:function(t){return "function"==typeof t?t.__proto__||{}:u$1(t)}:function(t){return _isVbObject(t)&&_getVbInternalOf(t).__proto__||{}};function s$1(t){return "function"==typeof t&&/\[native code\]/.test(t.toString())}function p$1(t,n){if(this instanceof p$1)return l$1(new y$1(t,n));h$1("Constructor Proxy requires 'new'");}function l$1(f){var s=f[t$1];return "function"==typeof s?function(n){var r=n[t$1];function o(){return this instanceof o?n["[[Construct]]"](arguments,o):n[e$1](this,arguments)}if(o.prototype=r.prototype,a$1){var c=j$1(n),f=O$1(u$1(r),c);for(var s in g$1(o,f),c=x$1(r,n))d$1(o,s)&&delete c[s];i$1(o,c);}else P$1(o,r);return o}(f):s instanceof Array?function(e){var i,f,s=e[t$1];a$1&&((i=j$1(e)).concat.get=function(){var t=e[n$1]("concat",this);return t===Array.prototype.concat?t.bind(s):t},f=O$1(u$1(s),i));return (i=x$1(s,e)).length.set=function(n){var i=n-s.length;e[r$1]("length",n,this),i&&function(n,r,e){var i=e[t$1];if(n>0)for(var u=i.length,a=u-n;a<u;++a){var f=c$1(r,a);f?o$1(i,a,f):i[a]=undefined,f=w$1(i,a,e),o$1(r,a,f);}else for(var s=(a=i.length)-n;a<s;++a)delete r[a];}(i,this,e);},O$1(f,i)}(f):function(n){var r,e,o=n[t$1];a$1&&(r=j$1(n),e=O$1(u$1(o),r));return r=x$1(o,n),O$1(e,r)}(f)}function y$1(n,r){v$1(n)&&v$1(r)||h$1("Cannot create proxy with a non-object as target or handler"),"REVOKED"===(f$a(n).__PROXY__||f$a(r).__PROXY__)&&h$1("Cannot create proxy with a revoked proxy as target or handler"),this[t$1]=n,this["[[ProxyHandler]]"]=r;}function _$1(t,n){t||h$1("Cannot perform '"+n+"' on a proxy that has been revoked");}function h$1(t){throw new TypeError(t)}function v$1(t){return !!t&&("object"==typeof t||"function"==typeof t)}function d$1(t,n){return Object.prototype.hasOwnProperty.call(t,n)}p$1.revocable=function(n,r){this instanceof p$1.revocable&&h$1("Proxy.revocable is not a constructor");var e=new y$1(n,r),o=l$1(e);return {proxy:o,revoke:function(){e[t$1]=undefined,e["[[ProxyHandler]]"]=undefined,a$1||(f$a(o).__PROXY__="REVOKED");}}},y$1.prototype[n$1]=function(n,r){var e=this["[[ProxyHandler]]"];return _$1(e,"get"),null==e.get?this[t$1][n]:"function"==typeof e.get?e.get(this[t$1],n,r):void h$1("Trap 'get' is not a function: "+e.get)},y$1.prototype[r$1]=function(n,r,e){var o=this["[[ProxyHandler]]"];if(_$1(o,"set"),null==o.set)this[t$1][n]=r;else if("function"==typeof o.set){o.set(this[t$1],n,r,e)||h$1("Trap 'set' returned false for property '"+n+"'");}else h$1("Trap 'set' is not a function: "+o.set);},y$1.prototype[e$1]=function(n,r){var e=this["[[ProxyHandler]]"];return _$1(e,"apply"),null==e.apply?this[t$1].apply(n,r):"function"==typeof e.apply?e.apply(this[t$1],n,r):void h$1("Trap 'apply' is not a function: "+e.apply)},y$1.prototype["[[Construct]]"]=function(n,r){var e,o=this["[[ProxyHandler]]"];if(_$1(o,"construct"),null==o.construct?e=function(t,n){for(var r=[],e=0,o=n.length;e<o;++e)r.push("args["+e+"]");return new Function("Ctor","args","return new Ctor("+r.join(", ")+")")(t,n)}(this[t$1],n):"function"==typeof o.construct?e=o.construct(this[t$1],n,r):h$1("Trap 'construct' is not a function: "+o.construct),v$1(e))return e;h$1("Trap 'construct' returned non-object: "+e);};var b$1=Object.getOwnPropertyNames||function(t){var n=[];for(var r in t)d$1(t,r)&&n.push(r);return n},g$1=s$1(Object.setPrototypeOf)?Object.setPrototypeOf:Object.__proto__?function(t,n){return t.__proto__=n,t}:function(t,n){return o$1(t,"__proto__",{value:n})},O$1=a$1?Object.create:function(t,n){var r=i$1({},n);if(_isVbObject(r)){var e={__PROXY__:undefined};_getVbInternalOf(r).__proto__=e;}return r},P$1=Object.assign||function(t,n){for(var r in n)d$1(n,r)&&(t[r]=n[r]);return t};function j$1(n){for(var r={},e=n[t$1];e=u$1(e);){var o=x$1(e,n);P$1(r,o);}return r.__PROXY__={get:function(){return n[t$1]?undefined:"REVOKED"}},r}function x$1(t,n){for(var r=b$1(t),e={},o=r.length-1;o>=0;--o)e[r[o]]=w$1(t,r[o],n);return e}function w$1(t,e,o){var i=c$1(t,e);return {get:function(){return o[n$1](e,this)},set:function(t){o[r$1](e,t,this);},enumerable:i.enumerable,configurable:i.configurable}}var C$1="undefined"==typeof Proxy?p$1:Proxy;
	...
	function () {
	  ...
	  ProxySandbox.prototype.createProxySandbox = function () {
	    ...
	    var _a = this,
	        ...
	        updatedValueSet = _a.updatedValueSet;

	    var self = this;
	    var rawWindow = window;

	    var _b = createFakeWindow(rawWindow),
	        fakeWindow = _b.fakeWindow,
	        propertiesWithGetter = _b.propertiesWithGetter;
	    ...
	    var sandbox = new PROXY(fakeWindow, {
	      set: function set(target, p, value) {
	        ...
	        if (self.sandboxRunning) {
	          ...
	          updatedValueSet.add(p); // eslint-disable-next-line no-param-reassign
	      ...
	      get: function get(target, p) {
	        ...
	        if (p === 'hasOwnProperty') {
	          // eslint-disable-next-line no-prototype-builtins
	          return function (key) {
	            return !!target[key] || rawWindow.hasOwnProperty(key);
	          };
	  ...
	  ProxySandbox.prototype.execScriptInSandbox = function (script) {
	  ...
	  ProxySandbox.prototype.clear = function () {
	    var _this = this;
	...
	function hijack$3() {
	  return [hijack$1(), hijack$2(), hijack()];
	}

	function createSandbox(appName) {
	  var sandbox = new ProxySandbox({
	    name: appName
	    ...
	    mount: function mount() {
	      return __awaiter(this, void 0, void 0, function () {
	        return __generator(this, function (_a) {
	          ...
	          mountingFreers.push.apply(mountingFreers, __spread(hijack$3()));
	          /* ------------------------------------------ 3. 重置一些初始化时的副作用 ------------------------------------------*/
	    ...
	    unmount: function unmount() {
	      return __awaiter(this, void 0, void 0, function () {
	        return __generator(this, function (_a) {
	          ...
	          mountingFreers.forEach(function (free) {
	      ...
	      switch (_m.label) {
	        ...
	        case 4:
	          ...
	          if (sandbox) {
	            ...
	            console.log(sandboxInstance.proxy, 'sandboxInstance.proxy sandboxInstance.proxy '); // 用沙箱的代理对象作为接下来使用的全局对象
